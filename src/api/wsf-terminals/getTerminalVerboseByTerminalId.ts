...
/**
 * API function for fetching terminal verbose for a specific terminal from WSF Terminals API
 *
 * Retrieves comprehensive terminal information for a specific terminal identified by terminal ID,
 * including all details about facilities, services, transportation options, and current status.
 * This endpoint provides the most complete information available for the specified terminal.
 *
...
export const getTerminalVerboseByTerminalIdParamsSchema = z
  ...
  .describe(
    "Parameters for retrieving verbose information for a specific terminal by ID."
  );
