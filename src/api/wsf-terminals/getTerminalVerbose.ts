...
/**
 * React Query hook for fetching all terminal verbose information
 *
 * Retrieves comprehensive terminal information including locations, amenities,
 * transportation options, bulletins, and wait times.
 *
