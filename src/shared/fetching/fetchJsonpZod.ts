/**
 * @fileoverview JSONP Fetch Tool with Zod Validation
 *
 * This module provides type-safe API access using JSONP with both
...
/**
 * JSONP fetch with full Zod validation and .NET date conversion
 *
 * This tool provides type-safe API access using JSONP with both
 * input and output validation using Zod schemas, plus automatic conversion
 * of .NET datetime strings to JavaScript Date objects.
 * Use this in browser environments to bypass CORS restrictions.
 *
 ...
 */
export const fetchJsonpZod: FetchTool = async <
  TInput = never,
  TOutput = unknown,
>(
