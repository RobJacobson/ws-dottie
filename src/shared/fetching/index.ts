/**
 * Shared fetching utilities for WSDOT APIs
 *
...
// Re-export date parsing utilities from the zod module
export {
  isWsdotDateString,
  jsDateToYyyyMmDd,
...
// Re-export fetch strategy implementations and types
export {
...
// Re-export the main zodFetch utility for validated API requests
export { zodFetch } from "../zod";
