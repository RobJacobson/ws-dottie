...
import {
  type Bulletin,
  bulletinSchema,
} from "../terminalBulletins/terminalBulletins.output";
import {
  type DispGISZoomLoc,
  dispGISZoomLocSchema,
} from "../terminalLocations/terminalLocations.output";
import {
  type DepartingSpace,
  departingSpaceSchema,
  type SpaceForArrivalTerminal,
} from "../terminalSailingSpace/terminalSailingSpace.output";
import {
  type TransitLink,
  transitLinkSchema,
} from "../terminalTransports/terminalTransports.output";
import {
  type WaitTime,
  waitTimeSchema,
} from "../terminalWaitTimes/terminalWaitTimes.output";
