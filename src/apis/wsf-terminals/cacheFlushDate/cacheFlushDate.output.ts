...
export const cacheFlushDateSchema = zDotnetDate()
  .optional()
  .describe(
    "Cache flush timestamp indicating when terminal data was last updated, as a UTC datetime. E.g., '2025-11-02T19:45:00.517Z' when terminal metadata was refreshed. Use to determine when cached terminal information should be invalidated and refreshed. Poll this endpoint periodically to detect when terminal data changes."
  );
