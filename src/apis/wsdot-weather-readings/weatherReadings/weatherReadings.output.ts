...
export const weatherReadingSchema = z
  .object({
    ...
    RelativeHumidty: z
      ...
      .nullable()
      .describe(
        "Percent of moisture in the air. A relative humidity of 0% shows that the air contains no moisture and 10% shows that the air is completely saturated and cannot absorb more moisture."
      ),
    /**
