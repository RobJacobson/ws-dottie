...
export const scheduleByTripDateAndDepartingTerminalIdAndTerminalIdsInputSchema =
  z
    .object({
      TripDate: z
        .string()
...
export type ScheduleByTripDateAndDepartingTerminalIdAndTerminalIdsInput =
  z.infer<
    typeof scheduleByTripDateAndDepartingTerminalIdAndTerminalIdsInputSchema
  >;
