 ...
 * This operation provides sailings for a particular scheduled route. Sailings are departure times
 * organized by direction of travel (eastbound / westbound), days of operation groups (daily, weekday, weekend, etc)
 * and, in some cases, date ranges (eg. Early Fall / Late Fall). Sailings largely mimic the groupings of
 * departures found on the printed PDF version of the schedule.
 */
 ...
 */
export const sailingResponsesArraySchema = z
  .array(sailingResponseSchema)
  .describe("Sailings for a particular scheduled route.");

export type SailingResponsesArray = z.infer<typeof sailingResponsesArraySchema>;
