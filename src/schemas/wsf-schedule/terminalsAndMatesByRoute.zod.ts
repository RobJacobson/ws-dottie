...
export const terminalsAndMatesByRouteSchema = z.object({
  ...
  DepartingTerminalID: z.number().int().describe(
    "Unique identifier for the departing terminal."
  ),
  ...
  ArrivingTerminalID: z.number().int().describe(
    "Unique identifier for the arriving terminal."
  ),
...
export type TerminalsAndMatesByRoute = z.infer<typeof terminalsAndMatesByRouteSchema>;
