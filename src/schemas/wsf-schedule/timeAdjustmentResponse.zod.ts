...
export const timeAdjustmentResponseSchema = z.object({
  ...
  EventID: z.number().int().describe("Unique identifier for an event."),
 ...
 */
export const timeAdjustmentResponsesArraySchema = z
  .array(timeAdjustmentResponseSchema)
  .describe(
    "All additions and cancellations that deviate on specific dates from the scheduled times."
  );

export type TimeAdjustmentResponsesArray = z.infer<
  typeof timeAdjustmentResponsesArraySchema
>;
