...
/**
 * Schema for validating a single fare line item from the GET /farelineitems endpoint.
 *
 * This operation retrieves fares for either round trip or one-way departures available
 * for a given departing terminal, arriving terminal and trip date. For round trip input
 * please use 'true' to indicate round trip or 'false' to indicate a one-way journey.
 * A valid departing terminal may be found by using /terminals while a valid arriving
 * terminal may be found by using /terminalmates. Similarly, a valid trip date may be
