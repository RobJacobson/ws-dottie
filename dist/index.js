...
__export(index_exports, {
  API_BASES: () => API_BASES,
  API_KEY: () => API_KEY,
  CACHE_FLUSH_CONFIG: () => CACHE_FLUSH_CONFIG,
  FREQUENT_UPDATE_CONFIG: () => FREQUENT_UPDATE_CONFIG,
  INFREQUENT_UPDATE_CONFIG: () => INFREQUENT_UPDATE_CONFIG,
  WsfCacheProvider: () => WsfCacheProvider,
  buildWsfUrl: () => buildWsfUrl,
  createCacheFlushOptions: () => createCacheFlushOptions,
  createFrequentUpdateOptions: () => createFrequentUpdateOptions,
  createInfrequentUpdateOptions: () => createInfrequentUpdateOptions,
  createPersistentQueryClient: () => createPersistentQueryClient,
  dateToWsfDateTimeFormat: () => dateToWsfDateTimeFormat,
  dateToWsfFormat: () => dateToWsfFormat,
  dateToWsfPathFormat: () => dateToWsfPathFormat,
  dateToWsfTimeFormat: () => dateToWsfTimeFormat,
  fetchInternal: () => fetchInternal,
  fetchWsf: () => fetchWsf,
  fetchWsfArray: () => fetchWsfArray,
  getActiveSeasons: () => getActiveSeasons,
  getAlerts: () => getAlerts,
  getAllSailings: () => getAllSailings,
  getCacheFlushDateSchedule: () => getCacheFlushDateSchedule,
  getCacheFlushDateTerminals: () => getCacheFlushDateTerminals,
  getCacheFlushDateVessels: () => getCacheFlushDateVessels,
  getDateLabel: () => getDateLabel,
  getRouteDetails: () => getRouteDetails,
  getRouteDetailsByRoute: () => getRouteDetailsByRoute,
  getRouteDetailsByTerminals: () => getRouteDetailsByTerminals,
  getRoutes: () => getRoutes,
  getRoutesByTerminals: () => getRoutesByTerminals,
  getRoutesWithDisruptions: () => getRoutesWithDisruptions,
  getSailings: () => getSailings,
  getScheduleByRoute: () => getScheduleByRoute,
  getScheduleByTerminals: () => getScheduleByTerminals,
  getScheduleTodayByRoute: () => getScheduleTodayByRoute,
  getScheduleTodayByTerminals: () => getScheduleTodayByTerminals,
  getScheduledRoutes: () => getScheduledRoutes,
  getScheduledRoutesBySeason: () => getScheduledRoutesBySeason,
  getTerminalMates: () => getTerminalMates,
  getTerminalSailingSpace: () => getTerminalSailingSpace,
  getTerminalSailingSpaceById: () => getTerminalSailingSpaceById,
  getTerminalVerbose: () => getTerminalVerbose,
  getTerminalVerboseById: () => getTerminalVerboseById,
  getTerminals: () => getTerminals,
  getTerminalsAndMates: () => getTerminalsAndMates,
  getTerminalsByRoute: () => getTerminalsByRoute,
  getTimeAdjustments: () => getTimeAdjustments,
  getTimeAdjustmentsByRoute: () => getTimeAdjustmentsByRoute,
  getTimeAdjustmentsBySchedRoute: () => getTimeAdjustmentsBySchedRoute,
  getTodayWsfFormat: () => getTodayWsfFormat,
  getTomorrowWsfFormat: () => getTomorrowWsfFormat,
  getValidDateRange: () => getValidDateRange,
  getVesselLocations: () => getVesselLocations,
  getVesselLocationsByVesselId: () => getVesselLocationsByVesselId,
  getVesselVerbose: () => getVesselVerbose,
  getVesselVerboseById: () => getVesselVerboseById,
  getVessels: () => getVessels,
  getVesselsByRoute: () => getVesselsByRoute,
  isToday: () => isToday,
  isTomorrow: () => isTomorrow,
  parseWsfDateTime: () => parseWsfDateTime,
  parseWsfScheduleDate: () => parseWsfScheduleDate,
  parseWsfTime: () => parseWsfTime,
  transformWsfData: () => transformWsfData,
  useActiveSeasons: () => useActiveSeasons,
  useAlerts: () => useAlerts,
  useAllSailings: () => useAllSailings,
  useCacheFlushDateSchedule: () => useCacheFlushDateSchedule,
  useCacheFlushDateTerminals: () => useCacheFlushDateTerminals,
  useCacheFlushDateVessels: () => useCacheFlushDateVessels,
  useRouteDetails: () => useRouteDetails,
  useRouteDetailsByRoute: () => useRouteDetailsByRoute,
  useRouteDetailsByTerminals: () => useRouteDetailsByTerminals,
  useRoutes: () => useRoutes,
  useRoutesByTerminals: () => useRoutesByTerminals,
  useRoutesWithDisruptions: () => useRoutesWithDisruptions,
  useSailings: () => useSailings,
  useScheduleByRoute: () => useScheduleByRoute,
  useScheduleByTerminals: () => useScheduleByTerminals,
  useScheduleTodayByRoute: () => useScheduleTodayByRoute,
  useScheduleTodayByTerminals: () => useScheduleTodayByTerminals,
  useScheduledRoutes: () => useScheduledRoutes,
  useScheduledRoutesBySeason: () => useScheduledRoutesBySeason,
  useStartupRefetch: () => useStartupRefetch,
  useTerminalMates: () => useTerminalMates,
  useTerminalSailingSpace: () => useTerminalSailingSpace,
  useTerminalSailingSpaceById: () => useTerminalSailingSpaceById,
  useTerminalVerbose: () => useTerminalVerbose,
  useTerminalVerboseById: () => useTerminalVerboseById,
  useTerminals: () => useTerminals,
  useTerminalsAndMates: () => useTerminalsAndMates,
  useTerminalsByRoute: () => useTerminalsByRoute,
  useTimeAdjustments: () => useTimeAdjustments,
  useTimeAdjustmentsByRoute: () => useTimeAdjustmentsByRoute,
  useTimeAdjustmentsBySchedRoute: () => useTimeAdjustmentsBySchedRoute,
  useValidDateRange: () => useValidDateRange,
  useVesselLocations: () => useVesselLocations,
  useVesselLocationsByVesselId: () => useVesselLocationsByVesselId,
  useVesselVerbose: () => useVesselVerbose,
  useVesselVerboseById: () => useVesselVerboseById,
  useVessels: () => useVessels,
  useVesselsByRoute: () => useVesselsByRoute,
  useWsfCacheFlushMonitor: () => useWsfCacheFlushMonitor,
  useWsfCacheInvalidation: () => useWsfCacheInvalidation
});
...
var WsfCacheProvider = () => {
  ...
  const previousVesselsFlushDate = (0, import_react.useRef)(null);
  const previousTerminalsFlushDate = (0, import_react.useRef)(null);
  const previousScheduleFlushDate = (0, import_react.useRef)(null);
