Reference for http://wsdot.wa.gov/Traffic/api/TrafficFlow/TrafficFlowREST.svc/GetTrafficFlowAsJson?AccessCode={ACCESSCODE}&FlowDataID={FLOWDATAID}
...
```
<FlowData xmlns="http://schemas.datacontract.org/2004/07/">
