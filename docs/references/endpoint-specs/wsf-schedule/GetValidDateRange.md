Reference for http://www.wsdot.wa.gov/Ferries/API/Schedule/rest/validdaterange?apiaccesscode={APIACCESSCODE}

**Url:** http://www.wsdot.wa.gov/Ferries/API/Schedule/rest/validdaterange?apiaccesscode={APIACCESSCODE}
...
```
<ValidDateRangeResponse xmlns="http://www.wsdot.wa.gov/ferries/schedule/">
...
<xs:schema xmlns:tns="http://www.wsdot.wa.gov/ferries/schedule/" elementFormDefault="qualified" targetNamespace="http://www.wsdot.wa.gov/ferries/schedule/" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:complexType name="ValidDateRangeResponse">
    <xs:sequence>
      <name="DateFrom" type="xs:dateTime" />
      <name="DateThru" type="xs:dateTime" />
    </xs:sequence>
  </xs:complexType>
  <xs:element name="ValidDateRangeResponse" nillable="true" type="tns:ValidDateRangeResponse" />
</xs:schema>
```
