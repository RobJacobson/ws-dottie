Reference for http://www.wsdot.wa.gov/Ferries/API/Schedule/rest/timeadjbyschedroute/{SCHEDROUTEID}?apiaccesscode={APIACCESSCODE}

**Url:** http://www.wsdot.wa.gov/Ferries/API/Schedule/rest/timeadjbyschedroute/{SCHEDROUTEID}?apiaccesscode={APIACCESSCODE}
