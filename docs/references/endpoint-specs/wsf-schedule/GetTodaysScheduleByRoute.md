Reference for http://www.wsdot.wa.gov/Ferries/API/Schedule/rest/scheduletoday/{ROUTEID}/{ONLYREMAININGTIMES}?apiaccesscode={APIACCESSCODE}

**Url:** http://www.wsdot.wa.gov/Ferries/API/Schedule/rest/scheduletoday/{ROUTEID}/{ONLYREMAININGTIMES}?apiaccesscode={APIACCESSCODE}
