Reference for http://www.wsdot.wa.gov/Ferries/API/Schedule/rest/timeadjbyroute/{ROUTEID}?apiaccesscode={APIACCESSCODE}

**Url:** http://www.wsdot.wa.gov/Ferries/API/Schedule/rest/timeadjbyroute/{ROUTEID}?apiaccesscode={APIACCESSCODE}
