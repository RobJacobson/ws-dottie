Reference for http://www.wsdot.wa.gov/Ferries/API/Schedule/rest/alternativeformats/{SUBJECTNAME}?apiaccesscode={APIACCESSCODE}

**Url:** http://www.wsdot.wa.gov/Ferries/API/Schedule/rest/alternativeformats/{SUBJECTNAME}?apiaccesscode={APIACCESSCODE}
...
```
<ArrayOfAlternativeFormatsResponse xmlns="http://www.wsdot.wa.gov/ferries/schedule/">
