Reference for http://www.wsdot.wa.gov/Ferries/API/Terminals/rest/terminalsailingspace?apiaccesscode={APIACCESSCODE}

**Url:** http://www.wsdot.wa.gov/Ferries/API/Terminals/rest/terminalsailingspace?apiaccesscode={APIACCESSCODE}
...
```
<ArrayOfTerminalSailingSpaceResponse xmlns="http://www.wsdot.wa.gov/ferries/terminals/">
...
</ArrayOfTerminalSailingSpaceResponse>
```
...
<xs:schema xmlns:tns="http://www.wsdot.wa.gov/ferries/terminals/" elementFormDefault="qualified" targetNamespace="http://www.wsdot.wa.gov/ferries/terminals/" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:complexType name="ArrayOfTerminalSailingSpaceResponse">
    <xs:sequence>
      <maxOccurs="unbounded" name="TerminalSailingSpaceResponse" nillable="true" type="tns:TerminalSailingSpaceResponse" />
    </xs:sequence>
  </xs:complexType>
  <xs:element name="ArrayOfTerminalSailingSpaceResponse" nillable="true" type="tns:ArrayOfTerminalSailingSpaceResponse" />
