Reference for http://www.wsdot.wa.gov/Ferries/API/Terminals/rest/terminallocations?apiaccesscode={APIACCESSCODE}

**Url:** http://www.wsdot.wa.gov/Ferries/API/Terminals/rest/terminallocations?apiaccesscode={APIACCESSCODE}
...
```
<ArrayOfTerminalLocationResponse xmlns="http://www.wsdot.wa.gov/ferries/terminals/">
...
</ArrayOfTerminalLocationResponse>
```
...
<xs:schema xmlns:tns="http://www.wsdot.wa.gov/ferries/terminals/" elementFormDefault="qualified" targetNamespace="http://www.wsdot.wa.gov/ferries/terminals/" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:complexType name="ArrayOfTerminalLocationResponse">
    <xs:sequence>
      <maxOccurs="unbounded" name="TerminalLocationResponse" nillable="true" type="tns:TerminalLocationResponse" />
    </xs:sequence>
  </xs:complexType>
  <xs:element name="ArrayOfTerminalLocationResponse" nillable="true" type="tns:ArrayOfTerminalLocationResponse" />
