Reference for http://wsdot.wa.gov/Traffic/api/TollRates/TollRatesREST.svc/GetTripRatesByDateAsJson?AccessCode={ACCESSCODE}&fromDate={FROMDATE}&toDate={TODATE}

**Url:** http://wsdot.wa.gov/Traffic/api/TollRates/TollRatesREST.svc/GetTripRatesByDateAsJson?AccessCode={ACCESSCODE}&fromDate={FROMDATE}&toDate={TODATE}
...
```
<ArrayOfTollTrips xmlns="http://schemas.datacontract.org/2004/07/">
  <TollTrips>
...
<xs:schema xmlns:tns="http://schemas.datacontract.org/2004/07/" elementFormDefault="qualified" targetNamespace="http://schemas.datacontract.org/2004/07/" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:complexType name="ArrayOfTollTrips">
    <xs:sequence>
      <maxOccurs="unbounded" name="TollTrips" nillable="true" type="tns:TollTrips" />
    </xs:sequence>
  </xs:complexType>
  <xs:element name="ArrayOfTollTrips" nillable="true" type="tns:ArrayOfTollTrips" />
