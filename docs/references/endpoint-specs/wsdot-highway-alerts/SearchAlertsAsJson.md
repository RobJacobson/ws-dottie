Reference for http://wsdot.wa.gov/Traffic/api/HighwayAlerts/HighwayAlertsREST.svc/SearchAlertsAsJson?AccessCode={ACCESSCODE}&StateRoute={STATEROUTE}&Region={REGION}&SearchTimeStart={SEARCHTIMESTART}&SearchTimeEnd={SEARCHTIMEEND}&StartingMilepost={STARTINGMILEPOST}&EndingMilepost={ENDINGMILEPOST}

Search for alerts for a specified time and route in JSON format

**Url:** http://wsdot.wa.gov/Traffic/api/HighwayAlerts/HighwayAlertsREST.svc/SearchAlertsAsJson?AccessCode={ACCESSCODE}&StateRoute={STATEROUTE}&Region={REGION}&SearchTimeStart={SEARCHTIMESTART}&SearchTimeEnd={SEARCHTIMEEND}&StartingMilepost={STARTINGMILEPOST}&EndingMilepost={ENDINGMILEPOST}
...
```
<ArrayOfAlert xmlns="http://schemas.datacontract.org/2004/07/">
  <Alert>
    <AlertID>2147483647</AlertID>
    ...
    <EventStatus>String content</EventStatus>
    <ExtendedDescription>String content</ExtendedDescription>
    <HeadlineDescription>String content</HeadlineDescription>
    <LastUpdatedTime>1999-05-31T11:20:00</LastUpdatedTime>
...
\[{
	...
	"LastUpdatedTime":"\\/Date(928174800000-0700)\\/",
...
<xs:schema xmlns:tns="http://schemas.datacontract.org/2004/07/" elementFormDefault="qualified" targetNamespace="http://schemas.datacontract.org/2004/07/" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:complexType name="ArrayOfAlert">
    <xs:sequence>
      <maxOccurs="unbounded" name="Alert" nillable="true" type="tns:Alert" />
    </xs:sequence>
  </xs:complexType>
  <xs:element name="ArrayOfAlert" nillable="true" type="tns:ArrayOfAlert" />
  <xs:complexType name="Alert">
    <xs:sequence>
      <name="AlertID" type="xs:int" />
      <name="County" nillable="true" type="xs:string" />
      <name="EndRoadwayLocation" nillable="true" type="tns:RoadwayLocation" />
      <name="EndTime" nillable="true" type="xs:dateTime" />
      <name="EventCategory" nillable="true" type="xs:string" />
      <name="EventStatus" nillable="true" type="xs:string" />
      <name="ExtendedDescription" nillable="true" type="xs:string" />
      <name="HeadlineDescription" nillable="true" type="xs:string" />
      <name="LastUpdatedTime" nillable="true" type="xs:dateTime" />
      <name="Priority" nillable="true" type="xs:string" />
      <name="Region" nillable="true" type="xs:string" />
      <name="StartRoadwayLocation" nillable="true" type="tns:RoadwayLocation" />
      <name="StartTime" nillable="true" type="xs:dateTime" />
    </xs:sequence>
  </xs:complexType>
