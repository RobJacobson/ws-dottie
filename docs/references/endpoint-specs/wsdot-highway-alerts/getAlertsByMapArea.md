Reference for http://wsdot.wa.gov/Traffic/api/HighwayAlerts/HighwayAlertsREST.svc/GetAlertsByMapAreaAsJson?AccessCode={ACCESSCODE}&MapArea={MAPAREA}

Current traffic alerts limited to a specific map area in JSON format

**Url:** http://wsdot.wa.gov/Traffic/api/HighwayAlerts/HighwayAlertsREST.svc/GetAlertsByMapAreaAsJson?AccessCode={ACCESSCODE}&MapArea={MAPAREA}
