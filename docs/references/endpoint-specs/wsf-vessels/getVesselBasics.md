Reference for http://www.wsdot.wa.gov/Ferries/API/Vessels/rest/vesselbasics?apiaccesscode={APIACCESSCODE}

**Url:** http://www.wsdot.wa.gov/Ferries/API/Vessels/rest/vesselbasics?apiaccesscode={APIACCESSCODE}
...
```
<ArrayOfVesselBasicResponse xmlns="http://www.wsdot.wa.gov/ferries/vessels/">
  <VesselBasicResponse>
...
<xs:schema xmlns:tns="http://www.wsdot.wa.gov/ferries/vessels/" elementFormDefault="qualified" targetNamespace="http://www.wsdot.wa.gov/ferries/vessels/" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  ...
  <xs:complexType name="ArrayOfVesselBasicResponse">
    <xs:sequence>
      <maxOccurs="unbounded" name="VesselBasicResponse" nillable="true" type="tns:VesselBasicResponse" />
    </xs:sequence>
  </xs:complexType>
  <xs:element name="ArrayOfVesselBasicResponse" nillable="true" type="tns:ArrayOfVesselBasicResponse" />
  <xs:complexType name="VesselBasicResponse">
    <xs:sequence>
  ...
  <xs:element name="VesselBasicResponse" nillable="true" type="tns:VesselBasicResponse" />
