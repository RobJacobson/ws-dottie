Reference for http://www.wsdot.wa.gov/Ferries/API/Vessels/rest/vesselstats?apiaccesscode={APIACCESSCODE}

**Url:** http://www.wsdot.wa.gov/Ferries/API/Vessels/rest/vesselstats?apiaccesscode={APIACCESSCODE}
...
```
<ArrayOfVesselStatResponse xmlns="http://www.wsdot.wa.gov/ferries/vessels/">
  <VesselStatResponse>
...
<xs:schema xmlns:tns="http://www.wsdot.wa.gov/ferries/vessels/" elementFormDefault="qualified" targetNamespace="http://www.wsdot.wa.gov/ferries/vessels/" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:complexType name="ArrayOfVesselStatResponse">
    <xs:sequence>
      <maxOccurs="unbounded" name="VesselStatResponse" nillable="true" type="tns:VesselStatResponse" />
    </xs:sequence>
  </xs:complexType>
  <xs:element name="ArrayOfVesselStatResponse" nillable="true" type="tns:ArrayOfVesselStatResponse" />
  <xs:complexType name="VesselStatResponse">
    <xs:sequence>
  ...
  <xs:element name="VesselStatResponse" nillable="true" type="tns:VesselStatResponse" />
