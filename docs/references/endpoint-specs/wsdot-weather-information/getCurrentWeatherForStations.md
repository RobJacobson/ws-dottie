Reference for http://wsdot.wa.gov/Traffic/api/WeatherInformation/WeatherInformationREST.svc/GetCurrentWeatherForStationsAsJson?AccessCode={ACCESSCODE}&StationList={STATIONLIST}
...
**Url:** http://wsdot.wa.gov/Traffic/api/WeatherInformation/WeatherInformationREST.svc/GetCurrentWeatherForStationsAsJson?AccessCode={ACCESSCODE}&StationList={STATIONLIST}
