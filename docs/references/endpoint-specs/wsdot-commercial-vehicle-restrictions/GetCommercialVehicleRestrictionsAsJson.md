Reference for http://wsdot.wa.gov/Traffic/api/CVRestrictions/CVRestrictionsREST.svc/GetCommercialVehicleRestrictionsAsJson?AccessCode={ACCESSCODE}

Method to return current Commercial Vehicle restrictions in JSON format

**Url:** http://wsdot.wa.gov/Traffic/api/CVRestrictions/CVRestrictionsREST.svc/GetCommercialVehicleRestrictionsAsJson?AccessCode={ACCESSCODE}
...
```
<ArrayOfCVRestrictionData xmlns="http://schemas.datacontract.org/2004/07/">
  <CVRestrictionData>
...
<xs:schema xmlns:tns="http://schemas.datacontract.org/2004/07/" elementFormDefault="qualified" targetNamespace="http://schemas.datacontract.org/2004/07/" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:complexType name="ArrayOfCVRestrictionData">
    <xs:sequence>
      <maxOccurs="unbounded" name="CVRestrictionData" nillable="true" type="tns:CVRestrictionData" />
    </xs:sequence>
  </xs:complexType>
  <xs:element name="ArrayOfCVRestrictionData" nillable="true" type="tns:ArrayOfCVRestrictionData" />
