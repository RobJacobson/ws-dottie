Reference for http://www.wsdot.wa.gov/Ferries/API/Fares/rest/farelineitemsbasic/{TRIPDATE}/{DEPARTINGTERMINALID}/{ARRIVINGTERMINALID}/{ROUNDTRIP}?apiaccesscode={APIACCESSCODE}
