Reference for http://www.wsdot.wa.gov/Ferries/API/Vessels/rest/vesselstats/{VESSELID}?apiaccesscode={APIACCESSCODE}

**Url:** http://www.wsdot.wa.gov/Ferries/API/Vessels/rest/vesselstats/{VESSELID}?apiaccesscode={APIACCESSCODE}
...
```
<VesselStatResponse xmlns="http://www.wsdot.wa.gov/ferries/vessels/">
