Reference for http://www.wsdot.wa.gov/Ferries/API/Vessels/rest/vesselverbose/{VESSELID}?apiaccesscode={APIACCESSCODE}

**Url:** http://www.wsdot.wa.gov/Ferries/API/Vessels/rest/vesselverbose/{VESSELID}?apiaccesscode={APIACCESSCODE}
...
```
<VesselVerboseResponse xmlns="http://www.wsdot.wa.gov/ferries/vessels/">
