Reference for http://www.wsdot.wa.gov/Ferries/API/Vessels/rest/vesselbasics/{VESSELID}?apiaccesscode={APIACCESSCODE}

**Url:** http://www.wsdot.wa.gov/Ferries/API/Vessels/rest/vesselbasics/{VESSELID}?apiaccesscode={APIACCESSCODE}
...
```
<VesselBasicResponse xmlns="http://www.wsdot.wa.gov/ferries/vessels/">
