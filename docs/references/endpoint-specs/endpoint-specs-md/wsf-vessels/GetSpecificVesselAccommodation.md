Reference for http://www.wsdot.wa.gov/Ferries/API/Vessels/rest/vesselaccommodations/{VESSELID}?apiaccesscode={APIACCESSCODE}

**Url:** http://www.wsdot.wa.gov/Ferries/API/Vessels/rest/vesselaccommodations/{VESSELID}?apiaccesscode={APIACCESSCODE}
...
```
<VesselAccommodationResponse xmlns="http://www.wsdot.wa.gov/ferries/vessels/">
