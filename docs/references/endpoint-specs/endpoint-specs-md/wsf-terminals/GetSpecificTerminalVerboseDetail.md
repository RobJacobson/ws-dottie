Reference for http://www.wsdot.wa.gov/Ferries/API/Terminals/rest/terminalverbose/{TERMINALID}?apiaccesscode={APIACCESSCODE}

**Url:** http://www.wsdot.wa.gov/Ferries/API/Terminals/rest/terminalverbose/{TERMINALID}?apiaccesscode={APIACCESSCODE}
...
```
<TerminalVerboseResponse xmlns="http://www.wsdot.wa.gov/ferries/terminals/">
