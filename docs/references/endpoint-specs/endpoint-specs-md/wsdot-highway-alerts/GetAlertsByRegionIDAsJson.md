Reference for http://wsdot.wa.gov/Traffic/api/HighwayAlerts/HighwayAlertsREST.svc/GetAlertsByRegionIDAsJson?AccessCode={ACCESSCODE}&RegionId={REGIONID}

Retrieve alerts for a specific WSDOT region

**Url:** http://wsdot.wa.gov/Traffic/api/HighwayAlerts/HighwayAlertsREST.svc/GetAlertsByRegionIDAsJson?AccessCode={ACCESSCODE}&RegionId={REGIONID}
