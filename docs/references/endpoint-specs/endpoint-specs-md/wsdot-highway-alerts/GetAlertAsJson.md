Reference for http://wsdot.wa.gov/Traffic/api/HighwayAlerts/HighwayAlertsREST.svc/GetAlertAsJson?AccessCode={ACCESSCODE}&AlertID={ALERTID}

Search for a single alert in JSON format

**Url:** http://wsdot.wa.gov/Traffic/api/HighwayAlerts/HighwayAlertsREST.svc/GetAlertAsJson?AccessCode={ACCESSCODE}&AlertID={ALERTID}
...
```
<Alert xmlns="http://schemas.datacontract.org/2004/07/">
