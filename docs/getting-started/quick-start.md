...
- **[Validation Guide](./guides/validation-guide.md)** - Zod validation system and best practices
...
- **96+ endpoints** with comprehensive data access
...
|-----------|------------------|------------------|
| Real-time (Vessels, Alerts) | 5 seconds | `REALTIME` |
| Frequent (Wait Times, Traffic) | 5 minutes | `FREQUENT` |
| Moderate (Weather, Conditions) | 1 hour | `MODERATE` |
| Static (Terminals, Cameras, Schedules, Fares) | 1 day | `STATIC` |
...
### Category-Based Documentation
- [Ferries](./categories/ferries.md) - Vessel tracking, terminals, schedules, and fares
- [Traffic](./categories/traffic.md) - Highway alerts, traffic flow, and travel times
- [Weather](./categories/weather.md) - Weather conditions, stations, and mountain passes
- [Infrastructure](./categories/infrastructure.md) - Bridge clearances, toll rates, and border crossings

### Implementation Guides
- [TanStack Query Guide](./guides/tanstack-query.md) - React integration with TanStack Query
- [Fetching Data Guide](./guides/fetching-data.md) - Basic fetch-dottie usage patterns
- [CLI Usage Guide](./guides/cli-usage.md) - Command-line interface and debugging
- [Error Handling Guide](./guides/error-handling.md) - Troubleshooting common issues

### Reference Materials
- [Endpoints Reference](./endpoints.md) - Complete endpoint reference table
- [Migration Guide](./guides/migration-guide.md) - Version migration instructions
- [Performance Guide](./guides/performance-guide.md) - Optimization tips and techniques

### Interactive Documentation
- [OpenAPI Specifications](../../openapi/) - API specifications in YAML format
- [HTML Documentation](../../redoc/) - Interactive HTML documentation with examples
