Reference for http://www.wsdot.wa.gov/Ferries/API/Terminals/rest/terminalbulletins/{TERMINALID}?apiaccesscode={APIACCESSCODE}

**Url:** http://www.wsdot.wa.gov/Ferries/API/Terminals/rest/terminalbulletins/{TERMINALID}?apiaccesscode={APIACCESSCODE}
...
```
<TerminalBulletinResponse xmlns="http://www.wsdot.wa.gov/ferries/terminals/">
