Reference for http://www.wsdot.wa.gov/Ferries/API/Vessels/rest/vessellocations?apiaccesscode={APIACCESSCODE}

**Url:** http://www.wsdot.wa.gov/Ferries/API/Vessels/rest/vessellocations?apiaccesscode={APIACCESSCODE}
...
```
<ArrayOfVesselLocationResponse xmlns="http://www.wsdot.wa.gov/ferries/vessels/">
...
<xs:schema xmlns:tns="http://www.wsdot.wa.gov/ferries/vessels/" elementFormDefault="qualified" targetNamespace="http://www.wsdot.wa.gov/ferries/vessels/" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  ...
  <xs:complexType name="ArrayOfVesselLocationResponse">
    <xs:sequence>
      <maxOccurs="unbounded" name="VesselLocationResponse" nillable="true" type="tns:VesselLocationResponse" />
    </xs:sequence>
  </xs:complexType>
