Reference for http://wsdot.wa.gov/Traffic/api/TrafficFlow/TrafficFlowREST.svc/GetTrafficFlowsAsJson?AccessCode={ACCESSCODE}

**Url:** http://wsdot.wa.gov/Traffic/api/TrafficFlow/TrafficFlowREST.svc/GetTrafficFlowsAsJson?AccessCode={ACCESSCODE}
...
```
<ArrayOfFlowData xmlns="http://schemas.datacontract.org/2004/07/">
  <FlowData>
    <FlowDataID>2147483647</FlowDataID>
    <FlowReadingValue>Unknown</FlowReadingValue>
    <FlowStationLocation>
...
<xs:schema xmlns:tns="http://schemas.datacontract.org/2004/07/" elementFormDefault="qualified" targetNamespace="http://schemas.datacontract.org/2004/07/" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:complexType name="ArrayOfFlowData">
    <xs:sequence>
      <maxOccurs="unbounded" name="FlowData" nillable="true" type="tns:FlowData" />
    </xs:sequence>
  </xs:complexType>
  <xs:element name="ArrayOfFlowData" nillable="true" type="tns:ArrayOfFlowData" />
  <xs:complexType name="FlowData">
    <xs:sequence>
      <name="FlowDataID" type="xs:int" />
      <name="FlowReadingValue" type="tns:FlowStationReading" />
      <name="FlowStationLocation" nillable="true" type="tns:RoadwayLocation" />
      <name="Region" nillable="true" type="xs:string" />
      <name="StationName" nillable="true" type="xs:string" />
      <name="Time" type="xs:dateTime" />
    </xs:sequence>
  </xs:complexType>
  <xs:element name="FlowData" nillable="true" type="tns:FlowData" />
  <xs:simpleType name="FlowStationReading">
    <xs:restriction base="xs:string">
      <xs:enumeration value="Unknown" />
      <xs:enumeration value="WideOpen" />
  ...
  <xs:element name="FlowStationReading" nillable="true" type="tns:FlowStationReading" />
