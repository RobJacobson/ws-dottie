Reference for http://www.wsdot.wa.gov/Ferries/API/Schedule/rest/activeseasons?apiaccesscode={APIACCESSCODE}

**Url:** http://www.wsdot.wa.gov/Ferries/API/Schedule/rest/activeseasons?apiaccesscode={APIACCESSCODE}
...
```
<ArrayOfSchedBriefResponse xmlns="http://www.wsdot.wa.gov/ferries/schedule/">
  <SchedBriefResponse>
...
<xs:schema xmlns:tns="http://www.wsdot.wa.gov/ferries/schedule/" elementFormDefault="qualified" targetNamespace="http://www.wsdot.wa.gov/ferries/schedule/" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:complexType name="ArrayOfSchedBriefResponse">
    <xs:sequence>
      <maxOccurs="unbounded" name="SchedBriefResponse" nillable="true" type="tns:SchedBriefResponse" />
    </xs:sequence>
  </xs:complexType>
  <xs:element name="ArrayOfSchedBriefResponse" nillable="true" type="tns:ArrayOfSchedBriefResponse" />
  <xs:complexType name="SchedBriefResponse">
    <xs:sequence>
  ...
  <xs:element name="SchedBriefResponse" nillable="true" type="tns:SchedBriefResponse" />
