Reference for http://www.wsdot.wa.gov/Ferries/API/Schedule/rest/routeshavingservicedisruptions/{TRIPDATE}?apiaccesscode={APIACCESSCODE}

**Url:** http://www.wsdot.wa.gov/Ferries/API/Schedule/rest/routeshavingservicedisruptions/{TRIPDATE}?apiaccesscode={APIACCESSCODE}
