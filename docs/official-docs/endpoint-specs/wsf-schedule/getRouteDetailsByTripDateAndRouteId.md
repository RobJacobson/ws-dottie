Reference for http://www.wsdot.wa.gov/Ferries/API/Schedule/rest/routedetails/{TRIPDATE}/{ROUTEID}?apiaccesscode={APIACCESSCODE}

**Url:** http://www.wsdot.wa.gov/Ferries/API/Schedule/rest/routedetails/{TRIPDATE}/{ROUTEID}?apiaccesscode={APIACCESSCODE}
...
```
<RouteResponse xmlns="http://www.wsdot.wa.gov/ferries/schedule/">
