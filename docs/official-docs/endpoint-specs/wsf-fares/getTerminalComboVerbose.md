Reference for http://www.wsdot.wa.gov/Ferries/API/Fares/rest/terminalcomboverbose/{TRIPDATE}?apiaccesscode={APIACCESSCODE}

**Url:** http://www.wsdot.wa.gov/Ferries/API/Fares/rest/terminalcomboverbose/{TRIPDATE}?apiaccesscode={APIACCESSCODE}
...
```
<ArrayOfTerminalComboVerboseResponse xmlns="http://www.wsdot.wa.gov/ferries/fares/">
...
</ArrayOfTerminalComboVerboseResponse>
```
