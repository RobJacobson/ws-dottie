Reference for http://www.wsdot.wa.gov/Ferries/API/Fares/rest/farelineitems/{TRIPDATE}/{DEPARTINGTERMINALID}/{ARRIVINGTERMINALID}/{ROUNDTRIP}?apiaccesscode={APIACCESSCODE}
