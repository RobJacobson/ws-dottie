 ...
 */
export const getWeatherInformationExtendedConfig: EndpointTestConfig<any, any> = {
  apiFunction: (params: any) => fetchWithZod(wsdot_weather_information_extended.getWeatherInformationExtended, params),
