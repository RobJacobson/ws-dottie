...
export const validators = {
  flowStationLocation: createValidator(schemas.flowStationLocation),
  trafficFlow: createValidator(schemas.trafficFlow),
  trafficFlowsArray: createArrayValidator(schemas.trafficFlowsArray),
} as const; 