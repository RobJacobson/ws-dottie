...
export const validators = {
  travelRestriction: createValidator(schemas.travelRestriction),
  mountainPassCondition: createValidator(schemas.mountainPassCondition),
  mountainPassConditionsArray: createArrayValidator(schemas.mountainPassConditionsArray),
} as const; 