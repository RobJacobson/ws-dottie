...
/**
 * Pre-configured validators for WSDOT Border Crossings API
 */
export const validators = {
  borderCrossingLocation: createValidator(schemas.borderCrossingLocation),
  borderCrossingData: createValidator(schemas.borderCrossingData),
  borderCrossingsArray: createArrayValidator(schemas.borderCrossingsArray),
} as const; 