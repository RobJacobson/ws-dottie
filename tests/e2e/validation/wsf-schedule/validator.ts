...
export const validators = {
  ...
  scheduledRouteData: {
    validateSafe: (data: unknown) => schemas.scheduledRouteSchema.safeParse(data),
  },
  routeData: {
  ...
  timeAdjustmentData: {
    validateSafe: (data: unknown) => schemas.timeAdjustmentSchema.safeParse(data),
  },
  scheduleTerminalData: {
    validateSafe: (data: unknown) => schemas.scheduleTerminalSchema.safeParse(data),
  },
  scheduleTerminalComboData: {
    validateSafe: (data: unknown) => schemas.scheduleTerminalComboSchema.safeParse(data),
  },
  scheduleTimeData: {
    validateSafe: (data: unknown) => schemas.scheduleTimeSchema.safeParse(data),
  },
  scheduleResponseTerminalComboData: {
    validateSafe: (data: unknown) => schemas.scheduleResponseTerminalComboSchema.safeParse(data),
  },
  scheduleResponseData: {
    validateSafe: (data: unknown) => schemas.scheduleResponseSchema.safeParse(data),
  },
  scheduleDepartureData: {
    validateSafe: (data: unknown) => schemas.scheduleDepartureSchema.safeParse(data),
  },
  scheduleData: {
    validateSafe: (data: unknown) => schemas.scheduleSchema.safeParse(data),
  },
  validDateRangeData: {
    validateSafe: (data: unknown) => schemas.validDateRangeSchema.safeParse(data),
  },
  scheduleCacheFlushDateData: {
    validateSafe: (data: unknown) => schemas.scheduleCacheFlushDateSchema.safeParse(data),
  },
  activeSeasonData: {
    validateSafe: (data: unknown) => schemas.activeSeasonSchema.safeParse(data),
  },
  alternativeFormatData: {
    validateSafe: (data: unknown) => schemas.alternativeFormatSchema.safeParse(data),
  },

  // Array validators for API responses
  scheduledRoutesArray: {
    validateSafe: (data: unknown) => schemas.scheduledRoutesArraySchema.safeParse(data),
  },
  routesArray: {
    validateSafe: (data: unknown) => schemas.routesArraySchema.safeParse(data),
  },
  sailingsArray: {
    validateSafe: (data: unknown) => schemas.sailingsArraySchema.safeParse(data),
  },
  alertsArray: {
    validateSafe: (data: unknown) => schemas.alertsArraySchema.safeParse(data),
  },
  timeAdjustmentsArray: {
    validateSafe: (data: unknown) => schemas.timeAdjustmentsArraySchema.safeParse(data),
  },
  scheduleTerminalsArray: {
    validateSafe: (data: unknown) => schemas.scheduleTerminalsArraySchema.safeParse(data),
  },
  scheduleTerminalCombosArray: {
    validateSafe: (data: unknown) => schemas.scheduleTerminalCombosArraySchema.safeParse(data),
  },
  activeSeasonsArray: {
    validateSafe: (data: unknown) => schemas.activeSeasonsArraySchema.safeParse(data),
  },
  alternativeFormatsArray: {
    validateSafe: (data: unknown) => schemas.alternativeFormatsArraySchema.safeParse(data),
  },
} as const;
...
export const validationHelpers = {
  ...
  expectValidScheduledRoutesArray: (data: unknown, context: string = "scheduled routes array") => {
    ...
    if (!result.success) {
      ...
      throw new Error(`${context} validation failed: ${JSON.stringify(result.error.errors, null, 2)}`);
    }
    return result.data;
  },
  ...
  expectValidSailingsArray: (data: unknown, context: string = "sailings array") => {
  ...
  expectValidTimeAdjustmentsArray: (data: unknown, context: string = "time adjustments array") => {
  ...
  expectValidScheduleTerminalsArray: (data: unknown, context: string = "schedule terminals array") => {
  ...
  expectValidScheduleTerminalCombosArray: (data: unknown, context: string = "schedule terminal combos array") => {
  ...
  expectValidActiveSeasonsArray: (data: unknown, context: string = "active seasons array") => {
  ...
  expectValidAlternativeFormatsArray: (data: unknown, context: string = "alternative formats array") => {
