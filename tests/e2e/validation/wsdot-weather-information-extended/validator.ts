...
export const validators = {
  surfaceMeasurement: createValidator(schemas.surfaceMeasurement),
  subSurfaceMeasurement: createValidator(schemas.subSurfaceMeasurement),
  weatherReading: createValidator(schemas.weatherReading),
  weatherReadingsArray: createArrayValidator(schemas.weatherReadingsArray),
} as const; 