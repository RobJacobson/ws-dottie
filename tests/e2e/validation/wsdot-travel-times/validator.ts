...
export const validators = {
  travelTimeEndpoint: createValidator(schemas.travelTimeEndpoint),
  travelTimeRoute: createValidator(schemas.travelTimeRoute),
  travelTimesArray: createArrayValidator(schemas.travelTimesArray),
} as const; 