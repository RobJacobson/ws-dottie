...
/**
 * Pre-configured validators for WSDOT Bridge Clearances API
 */
export const validators = {
  bridgeDataGis: createValidator(schemas.bridgeDataGis),
  bridgeClearancesArray: createArrayValidator(schemas.bridgeClearancesArray),
} as const; 