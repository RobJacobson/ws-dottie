...
export const validators = {
  tollRate: createValidator(schemas.tollRate),
  tollTripInfo: createValidator(schemas.tollTripInfo),
  tollTripRate: createValidator(schemas.tollTripRate),
  tollTripRates: createValidator(schemas.tollTripRates),
  tollRatesArray: createArrayValidator(schemas.tollRatesArray),
  tollTripInfoArray: createArrayValidator(schemas.tollTripInfoArray),
} as const; 