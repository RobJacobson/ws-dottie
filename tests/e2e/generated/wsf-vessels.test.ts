/**
 * Auto-generated test file for wsf-vessels
 * Generated at: 2025-09-15T04:10:17.185Z
 * Test type: core
 */
...
import * as wsfvesselsClient from "@/clients/wsf-vessels";

describe("wsf-vessels API", () => {
  // Get all endpoints from the client module
  const clientExports = Object.values(wsfvesselsClient);
  const apiEndpoints = clientExports.filter((exported: any) => 
    exported && 
    typeof exported === "object" && 
    typeof exported.id === "string" &&
    typeof exported.api === "string" &&
    exported.api === "wsf-vessels"
  );

  console.log(`🔍 Found ${apiEndpoints.length} endpoints for wsf-vessels`);
